...
packs <- c(
  ...
  "KEGGREST", "magrittr", "tidyverse","gt34"
)
...
cond_uniq_sites <- readRDS(file.path("ALL_condensed_intsites.rds")) #TODO
...
gene_stats <- read.csv( # TODO, not sure where this comes from
    file.path("ALL_cart19_gene_stats.csv")) %>%
...
gene_impact <- readRDS( # TODO, not sure where this comes from
    file.path("ALL_cart19_gene_impact.rds")) %>%
  dplyr::select(
