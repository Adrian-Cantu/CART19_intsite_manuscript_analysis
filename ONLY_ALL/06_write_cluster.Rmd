...
knit: (
  function(inputFile, encoding) { 
    ...
    rmarkdown::render( 
      ...
      output_file = paste(ptrial,'_Scan_stats_single', Sys.Date(), '.pdf', sep='')) })
---
...
clust_name <- file.path(workingDir,'ONLY_ALL','cluster_reports',paste0("only_",TRIAL,"_long_clusters_",count_t,".rds"))
...
* **Cluster**: location on the genome. You can click to view in the UCSC genome browser (red marks are on the '+' strand and blue are on the '-' strand)
